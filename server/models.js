...
const userSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ['admin', 'kasa', 'garson', 'user'], default: 'user' }
}, { timestamps: true });
...
const orderSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['Beklemede', 'Hazırlanıyor', 'Tamamlandı', 'İptal'], default: 'Beklemede' },
  tableNumber: { type: String, required: true },
  customerName: { type: String }
}, { timestamps: true });

const eventSchema = new mongoose.Schema({
  eventType: { type: String, enum: ['view', 'click', 'cart_add'], required: true },
